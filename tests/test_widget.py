...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Visa Gold 5999414228426353", "Visa Gold 5999 41** **** 6353"),
        ("", "Введите корректный номер счета или карты!"),
        ("Счет ", "Введите корректный номер счета или карты!"),
        ("Visa Classic ", "Введите корректный номер счета или карты!"),
    ],
)
def test_mask_account_card(string: str, result: str) -> None:
